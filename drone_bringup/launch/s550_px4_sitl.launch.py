...
def generate_launch_description():
    ...
    # --- GZ HIL Bridge: Gazebo IMU + odom → MAVROS HIL_SENSOR → PX4 EKF2 ---
    # Converts Gazebo sensor data (FLU/ENU) to PX4 format (FRD/NED)
    # and generates barometer + magnetometer for EKF2
    gz_hil_bridge = Node(

...
def generate_launch_description():
    ...
    # --- Gazebo Sim (high pivot: 150 mm below base_link, S550 model.sdf) ---
    gz_sim = IncludeLaunchDescription(
        ...
        launch_arguments={'gz_args': PathJoinSubstitution([
            pkg_prj_gazebo,
            'worlds',
            'S550_att_test_pivot_high_world.sdf'
        ])}.items()
    )
    ...
    # --- Attitude Odom Publisher (FK from joint states, 150 mm pivot) ---
